...
- **Previous Item（上一条目）：[Item 84: Don’t depend on the thread scheduler（不要依赖线程调度器）](./Chapter-11/Chapter-11-Item-84-Don’t-depend-on-the-thread-scheduler)**
- **Next Item（下一条目）：[Item 86: Implement Serializable with great caution（非常谨慎地实现 Serializable）](./Chapter-12/Chapter-12-Item-86-Implement-Serializable-with-great-caution)**
