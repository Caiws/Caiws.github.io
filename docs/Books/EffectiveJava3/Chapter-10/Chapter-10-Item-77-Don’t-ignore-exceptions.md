...
- **Previous Item（上一条目）：[Item 76: Strive for failure atomicity（尽力保证故障原子性）](./Chapter-10/Chapter-10-Item-76-Strive-for-failure-atomicity)**
- **Next Item（下一条目）：[Chapter 11 Introduction（章节介绍）](./Chapter-11/Chapter-11-Introduction)**
