...
- **Previous Item（上一条目）：[Item 26: Do not use raw types（不要使用原始类型）](./Chapter-5-Item-26-Do-not-use-raw-types)**
- **Next Item（下一条目）：[Item 28: Prefer lists to arrays（list 优于数组）](./Chapter-5-Item-28-Prefer-lists-to-arrays)**
